...
export default  async  function getbudgetmanagementfillter (req,res)  {
            ...
            ,getproportion.percent9] 
              for (let i=0 ; i< arrayloop.length ; i++){    
               ...
               console.log("array = ", array)
                ...
                if(array.length > 0 ){
                    return( res.status(200).json({ message: 'Get budget management fillter success',array, success: true}))
                    
                }

                else{
                    return ( res.status(400).json({message: 'Get budget management fillter failed',gettransactions, success: false}))
                }
