...
export default  async  function getsummary (req,res)  {
    ...
    try{
                ...
                if(gettransactions){
                    return( res.status(200).json({ message: 'Get summary success',sumbalance,arrayperson, success: true}))
                    
                }

                else{
                    return ( res.status(400).json({message: 'Get summary failed', success: false}))
                }
