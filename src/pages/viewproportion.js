...
export default function Viewproportion(){
    ...
    return(
        ...
        <div class=" w-[23.5rem] h-full bg-[#FAE392] rounded-t-[36px] mt-10">
            ...
            <div htmlFor="text" className="  text-[#9B7C0D] text-[24px] font-normal">-</div>
        ...
        <button className="bg-[#D8B4F8] mt-10 ml-32 mb-10 w-32 h-10 rounded-xl text-white font-rubik text-sm hover:bg-[#CA8DFF]">SETTING</button>
        </div>
        </div>
        </div>
