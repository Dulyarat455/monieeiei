...
export default function Createworkspace2() {
  ...
  const memberArray = Object.values(member).filter(
      ...
      <div className="flex flex-col items-center justify-center h-full ">
        ...
        <div className=" w-[23.5rem] h-full bg-[#FAE392] rounded-t-[36px] mt-10">
          <div className=" inline-flex">
            ...
            <button>
              <Image alt="Icon" src={Icon} className=" ml-12 mt-14"></Image>
            </button>
          </div>
          ...
          <form>
            <label
              htmlFor="email"
              className=" ml-14 text-[#9B7C0D] text-[20px] font-normal"
            >
              USER&apos;S EMAIL NO.1*
            </label>
            <br></br>
            <input
              className="mb-5 ml-14 h-10 w-[16rem] rounded-lg border-[1px] border-opacity-30 bg-[#FFFEF9] border-[#757575] placeholder-[#9B7C0D] placeholder:font-rubik pl-5 placeholder:text-[13px] placeholder:font-normal"
          ...
          <div className="inline-flex">
            <button
              className="bg-[#FFFEF9] mt-10 ml-12 w-32 h-10 rounded-xl border-2 border-[#CA8DFF] text-[#CA8DFF] font-rubik text-sm hover:bg-[#CA8DFF] hover:text-[#FFFFFF]"
              onClick={() => {
                moveBack();
              }}
            >
