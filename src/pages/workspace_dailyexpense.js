...
export default function Workspace_dailyexpense(){
    ...
    return(
        <div className={`min-h-screen bg-[#FFFEF9] ${inter.className}`}>
            ...
            <div className="text-[#1E1E1E] text-[32px] font-medium font-rubik mt-4 ml-12 flex">Workspace</div>
            <div className="ml-12 font-normal font-rubik text-[#A7A7A7]">Manage your workspace finances with friends and family</div>
            {/* Slide bar */}
