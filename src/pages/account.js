    ...
    const res = fetch("/api/getprofile", {
      ...
      .then((data) => {
        if (data.success) {
          ...
          setInfo({
            ...info,
            ["user_email"]: data.getAccount["user_email"],
    ...
    <div className={`min-h-screen bg-[#FFFEF9] ${inter.className}`}>
      <div className="flex flex-col items-center justify-center h-full ">
        ...
        <label
          ...
          className="text-[#757575] font-normal flex"
        >
          @ppppppp
        </label>
        ...
        <div className="item-center justify-centerl mt-4">
          ...
          <form>
            <label
              ...
              className="ml-2 text-[#A7A7A7] text-xs"
            >
              FIRST NAME
            </label>
            <br></br>
            ...
            <br></br>
            <input
              className="mb-2 ml-2 h-8 w-[16rem] rounded-lg border-[1px] border-opacity-30 bg-[#FFFEF9] border-[#757575] focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-400 focus:ring-opacity-60 placeholder-[#A7A7A7] placeholder:font-rubik pl-5 placeholder:text-[13px] placeholder:font-light flex"
              placeholder="Gates"
              type="text"
              id="user_lastname"
              name="user_lastname"
              ...
              onChange={changeHandler}
            ></input>
            <label htmlFor="user_DOB" className="ml-2 text-[#A7A7A7] text-xs">
              MY BIRTHDAY
            </label>
            <br></br>
            <input
            ...
            <input
              ...
              onChange={changeHandler}
            ></input>
            <label htmlFor="email" className="ml-2 text-[#A7A7A7] text-xs">
              MY EMAIL
            </label>
            <br></br>
            <input
            ...
            <Link
              href="/changepassword"
              className="ml-40 mt-1 text-[10px] mb-2 font-normal flex text-[#9747FF]"
            >
              Change my password
            </Link>
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              <button
                type="button"
                className="bg-[#D8B4F8] mx-auto mt-2 ml-18 w-24 h-10 rounded-xl text-white font-rubik text-sm hover:bg-[#CA8DFF]"
                onClick={() => {
                  submitHandler();
                }}
              >
