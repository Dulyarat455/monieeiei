            ...
            <div className="flex flex-col items-center justify-center h-full ">
                ...
                <div className="item-center justify-centerl mt-4">
                    ...
                    <form>
                        ...
                        <input className="mb-2 ml-2 h-8 w-[16rem] item-center rounded-lg border-[1px] border-opacity-30 bg-[#FFFEF9] border-[#757575] focus:outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400 placeholder-[#A7A7A7] placeholder:font-rubik pl-5 placeholder:text-[13px] placeholder:font-light flex" 
                        placeholder="Johny" 
                        type="text" 
                        id="user_firstname" 
                        name="user_firstname"
                        ...
                        <input className="mb-2 ml-2 h-8 w-[16rem] rounded-lg border-[1px] border-opacity-30 bg-[#FFFEF9] border-[#757575] focus:outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400 placeholder-[#A7A7A7] placeholder:font-rubik pl-5 placeholder:text-[13px] placeholder:font-light flex" 
                        placeholder="Gates" 
                        type="text" 
                        id="user_lastname" 
                        name="user_lastname" 
