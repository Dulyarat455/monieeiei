  ...
  return (
    <div className={`min-h-screen bg-[#FFFEF9] ${inter.className}`}>
      ...
      <div
        ...
        className="text-[#1E1E1E] font-medium font-rubik mt-4 ml-10 items-center justify-center"
      >
        Workspace
      </div>
      <div className="ml-10 me-10 font-normal text-base font-rubik text-[#A6A6A6] items-center justify-center sm:w-5/5 md:w-4/5 lg:w-1/5 ">
      ...
      <div className="flex flex-col items-center justify-center h-full pt-4">
        {info.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center mt-6 h-full">
            ...
            <label className="text-[#D9D9D9] text-xs font-normal font-rubik">
              Do not have the workspace for you
            </label>
          </div>
        )}
        ...
        <div className="flex flex-col justify-center items-center h-full mb-14">
          <Link href="/createworkspace">
            <button
              type="button"
              className="bg-[#D8B4F8] mt-4 w-44 h-12 border-bottom-4 rounded-lg text-white text-xs font-rubik hover:bg-[#CA8DFF]"
            >
              CREATE A WORKSPACE
            </button>
          </Link>
