    ...
    return(
        <div className={`min-h-screen bg-[#FFFEF9] ${inter.className}`}>
            ...
            <Navbar/> {/* Change to workspace */}
                ...
                <div className="ml-10 font-normal font-xxs font-rubik text-[#A7A7A7]">Manage your workspace finances with friends and family</div>
                <div className="flex flex-col items-center justify-center h-full pt-12">
                    {/* use component for worksapce name */}
