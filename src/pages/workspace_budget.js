...
export default function Workspace_dailyexpense(){
    ...
    return(
        <div className={`min-h-screen bg-[#FFFEF9] ${inter.className}`}>
            ...
            {/* Calendar */}
            <div style={{width:'screen', justifyContent:'space-between',padding:'0 30px'}} className="sm:w-full md:w-full lg:w-full xl:w-full 2xl:w-full flex mt-2 justify-start items-center">
                <div className="w-full sm:w-full md:w-full lg:w-full xl:w-full 2xl:w-full inline-flex justify-start items-center">
                    ...
                    <input style={{fontSize:'13px',width:'100%'}} className="justify-end w-full sm:w-full md:w-full lg:w-full xl:w-full 2xl:w-full h-[32px] p-2.5 bg-[#FFFEF9] rounded-lg border border-[#D9D9D9] focus:outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400 placeholder-[#A6A6A6] pl-2 placeholder-text-xs text-neutral-400 placeholder-font-rubik placeholder-font-normal"
                    placeholder="MM/DD/YYYY"
                    type="date"/>
                </div>
            </div>
