  ...
  return (
    <div className={`min-h-screen bg-[#FFFEF9] ${inter.className}`}>
      <div className="flex flex-col items-center justify-center h-full pt-10">
        ...
        <button
          type="submit"
          className=" mt-4 p-2 pl-6 pr-5 bg-[#D8B4F8] text-white rounded hover:bg-[#CA8DFF]"
          onClick={() => {
            moveRegister();
          }}
        >
        ...
        <button
          type="submit"
          className=" mt-4 p-2 pl-6 pr-5 border-2 border-CA8DFF text-CA8DFF rounded-md hover:bg-[#CA8DFF] hover:text-white"
          onClick={() => {
            moveLogin();
          }}
        >
