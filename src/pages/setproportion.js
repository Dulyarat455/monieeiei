        ...
        elems.push(
            <div key={idx} className="w-screen flex flex-col px-8 gap-4 h-max">
                <div className="flex w-full h-max text-[#9B7C0D] text-[24px] font-normal">
                    ...
                    <div className="flex w-1/5 ml-auto gap-2">
                        <input type="number" id={category.toLowerCase()} name={"percent"+idx}
                            value={percent_items[idx]}
                            onChange={changeHandler}
                            
                             
                            className=" rounded-lg border-[#9B7C0D] text-[#9B7C0D] text-[16px] font-normal w-4/5 pl-2 h-[2rem] "/>
                ...
                <div className="flex w-full  h-max text-[#9B7C0D] text-[24px]  font-normal">
                    ...
                    <div className="flex w-4/5 ml-auto gap-2">
                        <input type="number" id="budget" name="budget_value"
                            ...
                            onChange={changeHandler}
                             className=" rounded-lg border-[#9B7C0D] text-[#9B7C0D] text-[16px] font-normal w-4/5 pl-2"/>
