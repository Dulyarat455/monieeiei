...
export default function Dailyexpense() {
      ...
      .then((data) => {
        if (data.success) {
          ...
          for (let i = 0; i < data.allWorkSpaceMember.length; i++) {
            optionmembers.push({
              label: data.allWorkSpaceMember[i].user.user_username,
  ...
  const submitHandler = () => {
    if (
      info["amount"] &&
      info["tran_name"] &&
      (info["tran_type"] === 1 || info["tran_type"] === 0) &&
      info["bought_date"] &&
      info["pocket_name"]
    ) {
      if (
        (info["category_name"] && info["tran_type"] === 1) ||
        info["tran_type"] === 0
      ) {
    ...
    <div className={`min-h-screen bg-[#FFFEF9] ${inter.className}`}>
      <div className="flex flex-col items-center justify-center h-full ">
        ...
        <div class="  w-[23.5rem] h-full bg-[#FAE392] rounded-t-[36px] mt-10">
          <div className=" inline-flex">
            <div className="font-rubik mt-10 text-[32px] font-[500] ml-20">
              Daily Expense
            </div>
          ...
          <div className=" text-[400] text-[#9B7C0D] text-[20px] ml-24">
            {day} {month} {year}
          </div>{" "}
          {/*ใส่วันที่*/}
          ...
          <form>
            <label
              htmlFor="name"
              className=" ml-14 text-[#9B7C0D] text-[12px] font-[400] "
            >
              {"NAME*"}
            </label>
            <br></br>
            <input
              className="mb-5 ml-14 h-10 w-[16rem] rounded-lg border-[1px] border-opacity-30  bg-[#FFFEF9] border-[#757575] placeholder-[#9B7C0D] placeholder:font-rubik pl-5 placeholder:text-[13px] placeholder:font-normal text-[#9B7C0D] text-[12px] font-[400]"
            ...
            <label
              htmlFor="type"
              className=" ml-14 text-[#9B7C0D]  mt-2 text-[12px] font-[400]"
            >
              {"TYPE OF TRANSACTION*"}
            </label>
            <br></br>
            <div className=" inline-flex mt-2  ml-10">
              ...
              />
              <label
                className="text-[#9B7C0D] text-[12px] font-[400] mt-1 ml-2"
                for="expense"
              >
                EXPENSE
              </label>
            ...
            {radioCheck === 1 && (
              <div className="mt-2">
                ...
                <select
                  ...
                  id="category_name"
                  onChange={changeHandler}
                  className="text-[#9B7C0D] text-[14px] font-[400]  ml-14 pl-4 h-10 w-[16rem] rounded-lg border-[1px] border-opacity-30 bg-[#FFFEF9] border-[#757575]"
                >
                  <option className="ml-5" value="" disabled selected>
                    Select category
                  </option>
      ...
      /> */}
            ...
            <div className="mt-2">
              ...
              <br></br>
              <input
                className="ml-14 h-10 w-[16rem] rounded-lg border-[1px] border-opacity-30 bg-[#FFFEF9] border-[#757575] text-[#9B7C0D] text-[12px] font-[400]  placeholder-[#9B7C0D] placeholder:font-rubik pl-5 placeholder:text-[13px] placeholder:font-normal placeholder:pl-48"
                type="text"
                id="total"
                name="amount"
                placeholder="THB"
            ...
            <div className="mt-2">
              ...
              <br></br>
              <div className="inline-flex">
                <div className="pl-5 pt-3 text-[#9B7C0D] text-[12px] font-[400] rounded-lg border-[1px] border-opacity-30 bg-[#FFFEF9] border-[#757575] w-[16rem]  ml-14 h-10">
                  {filename}
                </div>
              ...
              <input
                className="mb-5  invisible hidden"
                type="file"
                accept=".jpg, .jpeg, .png"
                id="picture"
                name="picture"
          ...
          <div className="inline-flex">
            <button
              className="bg-[#FFFEF9] mt-10 ml-12 w-32 h-10 rounded-xl text-[#CA8DFF] font-rubik text-sm hover:bg-[#CA8DFF] hover:text-[#FFFFFF]"
              onClick={() => {
                router.push("/workspace_dailyexpense");
              }}
            >
            ...
            <button
              className="bg-[#D8B4F8] mt-10 ml-5 mb-10 w-32 h-10 rounded-xl text-white font-rubik text-sm hover:bg-[#CA8DFF]"
              onClick={() => {
                submitHandler();
              }}
            >
