...
export default function Workspacename({workspace_name, workspace_id , owner_status})
{
    ...
    return(
        <div className="workspace-container mt-4 relative">
            ...
            {owner_status === 1 &&
            (<span className="w-10 absolute top-0 right-2 h-[22px] absolute mt-2 top-30  text-xs text-[#219226] font-normal font-rubik px-2 py-1 bg-[#C5FFC7] bg-opacity-75 rounded justify-center items-center" >
                  own
                </span>)
            }
        </div>
